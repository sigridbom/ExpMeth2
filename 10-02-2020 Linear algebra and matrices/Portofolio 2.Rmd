...
nrow(brain) # 512 rows
ncol(brain) # 512 calumns
mean_brain <- mean(brain) # mean pixel value is 0.1869753
max(brain) # maximum pixel value is 0.9764706
min(brain) # minimum pixel value is 0

mask1 <- brain

mask1 <- ifelse mask1[,] => mean_brain <- 1

mask1[,1] > mean_brain <- 1

mask1 <- if (i in 1:512) x[i, i] > mean_brain <- 1.0 #Make the diagonal all 1's


mask1 <- matrix(ifelse: brain[,] > mean_brain <-  1 else <-  0)
